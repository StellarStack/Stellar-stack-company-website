            ...
            <div className=' mt-12 container mx-auto max-w-[1400px]'>
                ...
                <div className='md:flex gap-x-8'>
                    ...
                    <div className='px-12 md:px-0 md:w-[60%]'>
                        <h1 className='text-[26px] font-extrabold leading-[37px] pt-28'>Since 2018, StellarStack has been helping organizations<br></br> worldwide get reliable  websites  without any fuss. </h1>
