    ...
    return (
        ...
        <div className="bg-[#0d0d0d] pt-8 pb-4 header">
            ...
            <div className="text-center w-[10%] ">
                        <Image src='/images/LOGO TEXT.png' width={252} height={52} alt="" />
                    </div>

                    <div className=' sm:w-[90%] text-center md:block hidden pl-32'>
                 ...
                 <div className='md:w-[25%] pt-12 md:pt-0 md:flex  md:block hidden '>
