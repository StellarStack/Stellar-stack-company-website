        ...
        <>
            <div className='hero pb-20 md:pb-[280px] flex justify-center  text-center  '>
                <div className='text-white pt-20 md:pt-[220px] leading-none'>
                    <h1  className='text-[40px] heading md:text-[80px] font-medium'>Build Real-Time<br></br>
                        <span className='text-[40px] heading md:text-[70px] text-[#0399DA] font-normal '>Apps & Services</span></h1>
